...
import {
    ...
    AsyncSession,
    Business,
    ButtonAutoDetectionDeviceSelection,
    CanvasAppAsset,
    Comment,
    ...
    CustomAudience,
    CustomConversion,
    OfflineConversionDataSetStats,
    CommerceMerchantTaxSettings,
    Video,
    Post,
    SignalsUploadProgress,
    GamesIAPOrder,
    PagePost,
    AssignedUser,
    AudioCopyright,
...
export interface APIv9 extends APISpec {
    ...
    Application: {
        ...
        edges: {
            ...
            AdNetworkAnalyticsResults: EdgeSpec<
                AdNetworkAnalyticsAsyncQueryResult,
            ...
            ButtonAutoDetectionDeviceSelection: EdgeSpec<
                ButtonAutoDetectionDeviceSelection,
    ...
    Page: {
        ...
        edges: {
            ...
            CommerceMerchantSettings: EdgeSpec<
                CommerceMerchantSettings,
            ...
            InstantArticlesInsights: EdgeSpec<
                InstantArticleInsightsQueryResult,
...
export type APISpecNodeCollection<T extends APISpec> = {
...
export type EdgelessNodeSpec<NodeType> = {
    node: NodeSpec<NodeType>;
    edges: {};
};

type CommentsEdge = EdgeSpec<Comment, 'comments'> & {
    read_params: {
        /**
