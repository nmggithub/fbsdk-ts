declare type BackdatedTimeGranularityEnum = 'year' | 'month' | 'day' | 'hour' | 'min' | 'none';
...
export interface Application {
     ...
     */
    app_signals_binding_ios: unknown[];
    /**
     * App type
     */
    app_type: number;
     ...
     */
    supported_platforms: ('WEB' | 'CANVAS' | 'MOBILE_WEB' | 'IPHONE' | 'IPAD' | 'ANDROID' | 'WINDOWS' | 'AMAZON' | 'SUPPLEMENTARY_IMAGES' | 'GAMEROOM' | 'INSTANT_GAME' | 'OCULUS' | 'SAMSUNG')[];
    /**
...
interface StoryAttachment {
     ...
     */
    type: 'album' | 'animated_image_autoplay' | 'checkin' | 'cover_photo' | 'event' | 'link' | 'multiple' | 'music' | 'note' | 'offer' | 'photo' | 'profile_media' | 'status' | 'video' | 'video_autoplay';
    /**
...
export interface CommerceMerchantSettings {
     ...
     */
    cta: 'onsite checkout' | 'offsite' | 'contact-merchant' | string;
    /**
     ...
     */
    onsite_commerce_merchant: unknown;
    /**
...
interface Event {
     ...
     */
    category: 'ART_EVENT' | 'BOOK_EVENT' | 'MOVIE_EVENT' | 'FUNDRAISER' | 'VOLUNTEERING' | 'FAMILY_EVENT' | 'FESTIVAL_EVENT' | 'NEIGHBORHOOD' | 'RELIGIOUS_EVENT' | 'SHOPPING' | 'COMEDY_EVENT' | 'MUSIC_EVENT' | 'DANCE_EVENT' | 'NIGHTLIFE' | 'THEATER_EVENT' | 'DINING_EVENT' | 'FOOD_TASTING' | 'CONFERENCE_EVENT' | 'MEETUP' | 'CLASS_EVENT' | 'LECTURE' | 'WORKSHOP' | 'FITNESS' | 'SPORTS_EVENT' | 'OTHER';
    /**
     * Cover picture
     */
    cover: CoverPhoto;
...
export interface LiveEncoder {
     ...
     */
    status: 'ready' | 'register' | 'preview' | 'live' | string;
    /**
...
**Note:** If a business is open during the night, the closing time can not pass 6:00am. For example, `"mon_2_open":"13:15"` and `"mon_2_close":"5:59"` will work however `"mon_close_close":"6:00"` will not.
     ...
     */
    instant_articles_review_status: 'APPROVED' | 'NOT_SUBMITTED' | 'PENDING' | 'REJECTED' | 'SUSPENDED';
    /**
...
export interface Video {
     ...
     */
    content_category: 'BEAUTY_FASHION' | 'BUSINESS' | 'CARS_TRUCKS' | 'COMEDY' | 'CUTE_ANIMALS' | 'ENTERTAINMENT' | 'FAMILY' | 'FOOD_HEALTH' | 'HOME' | 'LIFESTYLE' | 'MUSIC' | 'NEWS' | 'POLITICS' | 'SCIENCE' | 'SPORTS' | 'TECHNOLOGY' | 'VIDEO_GAMING' | 'OTHER';
    /**
...
`    * ID for the Ad Set
     ...
     */
    billing_event: 'APP_INSTALLS' | 'CLICKS' | 'IMPRESSIONS' | 'LINK_CLICKS' | 'NONE' | 'OFFER_CLAIMS' | 'PAGE_LIKES' | 'POST_ENGAGEMENT' | 'THRUPLAY';
    /**
     ...
     */
    contextual_bundling_spec: unknown;
    /**
     ...
     */
    optimization_goal: 'NONE' | 'APP_INSTALLS' | 'BRAND_AWARENESS' | 'AD_RECALL_LIFT' | 'CLICKS' | 'ENGAGED_USERS' | 'EVENT_RESPONSES' | 'IMPRESSIONS' | 'LEAD_GENERATION' | 'QUALITY_LEAD' | 'LINK_CLICKS' | 'OFFER_CLAIMS' | 'OFFSITE_CONVERSIONS' | 'PAGE_ENGAGEMENT' | 'PAGE_LIKES' | 'POST_ENGAGEMENT' | 'QUALITY_CALL' | 'REACH' | 'SOCIAL_IMPRESSIONS' | 'APP_DOWNLOADS' | 'TWO_SECOND_CONTINUOUS_VIDEO_VIEWS' | 'LANDING_PAGE_VIEWS' | 'VISIT_INSTAGRAM_PROFILE' | 'VALUE' | 'THRUPLAY' | 'REPLIES' | 'DERIVED_EVENTS';
    /**
...
interface DeliveryCheck {
     ...
     */
    check_name: 'page_status' | 'mobile_eligible' | 'blocked_url' | 'invalid_custom_audiences' | 'logged_out_ads';
    /**
...
interface AdsPixel {
     ...
     */
    automatic_matching_fields: ('em' | 'fn' | 'ln' | 'ph' | 'ge' | 'zp' | 'ct' | 'st' | 'country' | 'db' | 'external_id')[];
    /**
     * can_proxy
     */
    can_proxy: boolean;
...
export declare type ApplicationPermissionStatus = 'live' | 'unapproved';
...
export declare type InsightBreakdown = 'none' | 'age' | 'acquisition_source' | 'acquisition_source_l1' | 'acquisition_source_l2' | 'acquisition_source_l3' | 'days_since_acquisition' | 'api_method' | 'app_version' | 'auth_state' | 'avg_spend_per_user' | 'city' | 'label_cohort' | 'country' | 'error_code' | 'error_msg' | 'gender' | 'identity_source' | 'locale' | 'media_type' | 'destination' | 'ref' | 'ads_account' | 'ads_method' | 'ads_account_method' | 'ads_errorcode' | 'ads_account_errorcode' | 'ads_method_errorcode' | 'ads_account_method_errorcode' | 'url' | 'sponsored' | 'placement' | 'purchase_events' | 'reach' | 'realized_revenue' | 'roas' | 'device_model' | 'device_os' | 'user_agent' | 'error_value' | 'attributor' | 'app' | 'fb_journey_start_channel' | 'fb_journey_end_channel' | 'fb_journey_is_converted' | 'fb_journey_channel_list' | 'fb_journey_start_event_source' | 'fb_journey_end_event_source' | 'fb_journey_event_source_list' | 'has_push_token' | 'app_name' | 'carrier' | 'core_count' | 'city_code' | 'region_code' | 'remaining_disk_gb' | 'screen_dimensions' | 'short_version_code' | 'timezone' | 'total_disk_gb' | 'ui_element' | 'action_type' | 'object_type' | 'client' | 'publishing_actor_type' | 'score' | 'display_format' | 'content_type' | 'data_source' | 'sdk_version' | 'app_event_parameter1' | 'app_event_parameter2' | 'app_event_parameter3' | 'app_event_parameter4' | 'app_event_parameter5' | 'app_event_parameter6' | 'app_event_parameter7' | 'app_event_parameter8' | 'app_event_parameter9' | 'app_event_parameter10';
export interface ProductCatalog {
     ...
     */
    vertical: 'adoptable_pets' | 'bookable' | 'commerce' | 'destinations' | 'flights' | 'home_listings' | 'hotels' | 'jobs' | 'local_delivery_shipping_profiles' | 'local_service_businesses' | 'offer_items' | 'offline_commerce' | 'ticketed_experiences' | 'transactable_items' | 'vehicles';
}
...
export interface CommerceReturn {
     ...
     */
    item_return_reasons: {
        [key: string]: 'BUYERS_REMORSE' | 'DAMAGED_GOODS' | 'NOT_AS_DESCRIBED' | 'QUALITY_ISSUE' | 'REFUND_COMPROMISED' | 'REFUND_FOR_RETURN' | 'REFUND_REASON_OTHER' | 'REFUND_SFI_FAKE' | 'REFUND_SFI_REAL' | 'WRONG_ITEM';
    };
    /**
     ...
     */
    return_status: 'APPROVED' | 'DISAPPROVED' | 'MERCHANT_MARKED_COMPLETED' | 'REFUNDED' | 'REQUESTED';
}
...
export interface CustomConversion {
     ...
     */
    custom_event_type: 'ADD_PAYMENT_INFO' | 'ADD_TO_CART' | 'ADD_TO_WISHLIST' | 'COMPLETE_REGISTRATION' | 'CONTENT_VIEW' | 'INITIATED_CHECKOUT' | 'LEAD' | 'PURCHASE' | 'SEARCH' | 'CONTACT' | 'CUSTOMIZE_PRODUCT' | 'DONATE' | 'FIND_LOCATION' | 'SCHEDULE' | 'START_TRIAL' | 'SUBMIT_APPLICATION' | 'SUBSCRIBE' | 'LISTING_INTERACTION' | 'FACEBOOK_SELECTED' | 'OTHER';
    /**
...
interface Vehicle {
     ...
     * BodyStyle
     */
    body_style: 'CONVERTIBLE' | 'COUPE' | 'CROSSOVER' | 'HATCHBACK' | 'MINIVAN' | 'SMALL_CAR' | 'TRUCK' | 'SUV' | 'SEDAN' | 'VAN' | 'WAGON' | 'OTHER' | 'NONE';
    /**
     * Condition
     */
     ...
     * FuelType
     */
    fuel_type: 'DIESEL' | 'ELECTRIC' | 'GASOLINE' | 'FLEX' | 'HYBRID' | 'OTHER' | 'PETROL' | 'PLUGIN_HYBRID' | 'NONE';
    /**
     * Images
     */
    images: string[];
     ...
     * VehicleType
     */
    vehicle_type: 'BOAT' | 'CAR_TRUCK' | 'COMMERCIAL' | 'MOTORCYCLE' | 'OTHER' | 'POWERSPORT' | 'RV_CAMPER' | 'TRAILER';
    /**
     * Vin
     */
    vin: string;
...
export interface PageCallToAction {
     ...
     */
    android_destination_type: 'WEBSITE' | 'APP_DEEPLINK' | 'FACEBOOK_APP' | 'PHONE_CALL' | 'MESSENGER' | 'EMAIL' | 'SHOP_ON_FACEBOOK' | 'NONE' | 'BECOME_A_VOLUNTEER' | 'FOLLOW' | 'MINI_SHOP' | 'MARKETPLACE_INVENTORY_PAGE' | 'MOBILE_CENTER';
    /**
     ...
     */
    iphone_destination_type: 'WEBSITE' | 'APP_DEEPLINK' | 'FACEBOOK_APP' | 'PHONE_CALL' | 'MESSENGER' | 'EMAIL' | 'SHOP_ON_FACEBOOK' | 'NONE' | 'BECOME_A_VOLUNTEER' | 'FOLLOW' | 'MINI_SHOP' | 'MARKETPLACE_INVENTORY_PAGE';
    /**
     ...
     */
    web_destination_type: 'EMAIL' | 'MESSENGER' | 'NONE' | 'WEBSITE' | 'SHOP_ON_FACEBOOK' | 'BECOME_SUPPORTER' | 'BECOME_A_VOLUNTEER' | 'FOLLOW' | 'MOBILE_CENTER';
    /**
...
export interface CommerceOrder {
     ...
     */
    estimated_payment_details: unknown;
    /**
     ...
     */
    selected_shipping_option: unknown;
    /**
...
interface MessengerProfilePersistentMenu {
    /**
     ...
     */
    call_to_actions: MessengerProfilePersistentMenuItem[];
}
interface MessengerProfilePersistentMenuItem {
    /**
    ...
    payload: string;
    /**
     * Height of the [webview](https://developers.facebook.com/docs/messenger-platform/send-api-reference/webview). Valid values include `compact`, `tall`, `full`.
     */
    webview_height_ratio: 'compact' | 'tall' | 'full';
    /**
     * Must be `true` if the item type is `web_url` and the [Messenger Extensions SDK](https://developers.facebook.com/docs/messenger-platform/send-api-reference/webview) will be used in the webview.
     */
    messenger_extensions: boolean;
    /**
     * URL to open in the webview for clients that do not support the [Messenger Extensions SDK](https://developers.facebook.com/docs/messenger-platform/send-api-reference/webview). If this is not defined, the `url` will be used as the fallback. It may only be specified if `"messenger_extensions": true`.
     */
    fallback_url: string;
    webview_share_button: 'hide' | string;
}
export interface InstagramUser {
    /**
     * ID of the Instagram user
...
export interface CommerceMerchantSettingsSetupStatus {
     ...
     */
    marketplace_approval_status_details: unknown;
    /**
