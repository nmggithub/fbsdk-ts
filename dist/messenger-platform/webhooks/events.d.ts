...
declare type MessageReceivedEventAttachment = XOR<[
...
export declare type MessageEchoEvent = XOR<[
...
export declare type PolicyEnforcementEvent = XOR<[
    PolicyEnforcementWarningOrBlockEvent,
    PolicyEnforcementUnblockEvent
]>;
