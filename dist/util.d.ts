...
declare type HasAtLeastTwo<T extends {}[]> = T[0] extends undefined ? false : T[1] extends undefined ? false : true;
declare type RemoveFirstTwo<T extends {}[]> = T extends [{}, {}, ...infer U] ? U extends {}[] ? U : never : never;
